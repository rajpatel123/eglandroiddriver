...
@Expose
private double outstationOnewayPrice;
...
public Integer getTourismPrice() {
return tourismPrice;
}

public void setTourismPrice(Integer tourismPrice) {
...
public double getOutstationOnewayPrice() {
return outstationOnewayPrice;
}

public void setOutstationOnewayPrice(double outstationOnewayPrice) {
