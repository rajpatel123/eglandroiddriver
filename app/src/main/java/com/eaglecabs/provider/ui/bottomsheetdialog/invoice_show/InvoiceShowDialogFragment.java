...
import static com.eaglecabs.provider.base.BaseActivity.DATUM_history_detail;
    ...
    private void init() {
        ...
        if (datum != null) {
            ...
            if (payment != null) {
                ...
                outstationDistanceTravelled.setText(String.valueOf(datum.getDriverEndDistance() + " km"));
